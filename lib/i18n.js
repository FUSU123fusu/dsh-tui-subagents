...
const dict = {
  ...
  'detail-hint': { zh: '↑/↓ 滚动 · PgUp/PgDn 翻页 · e 展开/收起思考 · G 到末尾 · Esc 返回列表', en: '↑/↓ scroll · PgUp/PgDn page · e toggle thinking · G jump to end · Esc back to list' },
  ...
  'detail-hint-talk': { zh: '↑/↓ 滚动 · PgUp/PgDn 翻页 · e 思考 · i 发消息 · x 中断本轮 · G 末尾 · Esc 返回', en: '↑/↓ scroll · PgUp/PgDn page · e thinking · i message · x interrupt turn · G end · Esc back' },
